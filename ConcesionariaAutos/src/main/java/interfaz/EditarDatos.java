...
public class EditarDatos extends javax.swing.JFrame {
    ...
    public EditarDatos(int numeroAutomovil) {
        controlador = new Controlador();
        this.numeroAutomovil = numeroAutomovil;
        initComponents();
        cargarDatosNumeroAutomovil(numeroAutomovil);
    }
    ...
    private void initComponents() {
        ...
        btnGuardar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/interfaz/imagenes/edit-icon.png"))); // NOI18N
        btnGuardar.setText("CAMBIAR");
        btnGuardar.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, null, null, new java.awt.Color(0, 102, 102), new java.awt.Color(51, 255, 255)));
        ...
        textfields.add(txtBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 480, 450));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/interfaz/imagenes/car2-700.png"))); // NOI18N
        textfields.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 220, -1, -1));

        jLabel12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/interfaz/imagenes/Synthwave-1000.png"))); // NOI18N
        textfields.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, -80, -1, -1));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        controlador.modificarAuto(automovil, modelo, marca, color, motor, patente, numeroPuertas);

        // Pasamos un mensaje por pantalla, para decirle al usuario que su auto fue registrado

        JOptionPane.showMessageDialog(null, "Su automóvil fue editado exitosamente");
    ...
    public void cargarDatosNumeroAutomovil(int numeroAutomovil) {
        
        this.automovil = controlador.buscarAutomovil(numeroAutomovil);
        ...
        txtPuertas.setText(String.valueOf(automovil.getCantidadPuertas()));
